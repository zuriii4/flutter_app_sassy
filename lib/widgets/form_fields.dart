...
//             } else {
//               croppedFile = await _simpleCropToSquare(file);
//             }
//           } catch (e) {
...
//   // Jednoduché automatické cropovanie do štvorca pre desktop
//   Future<File?> _simpleCropToSquare(File imageFile) async {
//     try {
//       // Len pre desktop platformy - automatické orezanie v strede
//       final bytes = await imageFile.readAsBytes();
//       final originalImage = img.decodeImage(bytes);
      
//       if (originalImage == null) return null;
      
//       // Vypočítame rozmer štvorca (menší z width a height)
//       final size = originalImage.width < originalImage.height
//           ? originalImage.width
//           : originalImage.height;
      
//       // Pozícia pre výrez (centrované)
//       final left = (originalImage.width - size) ~/ 2;
//       final top = (originalImage.height - size) ~/ 2;
...
//       // Uložíme cropnutý obrázok do dočasného súboru
...
//       return croppedFile;
//     } catch (e) {
//       print('Error during simple crop: $e');
//       // V prípade chyby vrátime pôvodný súbor
//       return imageFile;
//     }
//   }
  
//   // Manuálne cropovanie pomocou UI - alternatívna možnosť
//   Future<File?> _showCropDialog(File imageFile) async {
//     // Táto funkcia by mohla byť implementovaná neskôr ak by bolo
//     // potrebné manuálne cropovanie na desktope
//     return _simpleCropToSquare(imageFile);
//   }
...
//           const SizedBox(height: 8),
//           Text(
//             widget.cropToSquare ? 'Kliknite pre výber štvorcového obrázka' : 'Kliknutím vyberte súbor',
