...
//             ? _buildTeacherItems(context, userRole, onItemSelected)
//             : _buildStudentItems(context, onItemSelected),
...
//                             onPressed: () {
//                               onItemSelected(userRole == 'admin' ? 5 : 4);
//                             },
//                             icon: const Icon(
//                               Icons.add,
//                               color: Colors.white,
...
class ResponsiveSidebar extends StatefulWidget {
  ...
  final String userRole;
  final String userName;
  final Widget? child; // Pridáme parameter child pre obsah stránky v mobilnom režime
  ...
  const ResponsiveSidebar({
    ...
    required this.userRole,
    required this.userName,
    this.child, // Voliteľný parameter pre obsah stránky
  });
  ...
  Widget build(BuildContext context) {
    ...
    // Pre mobilný režim vracajte Drawer a AppBar s hamburger menu
      ...
      return Scaffold(
        ...
        body: widget.child ?? Container(), // Zobrazenie obsahu stránky
      );
    }
  }
